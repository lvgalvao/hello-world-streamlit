...
connection_string = 'Driver={ODBC Driver 18 for SQL Server};Server=tcp:meuservidorsqlserver.database.windows.net,1433;Database=meudatabase;Uid=dbaadmin;Pwd=SUASENHA@;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;'
